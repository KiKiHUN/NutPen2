  ...
  <script>
    ...
    console.log(now.startOf('week').add(9, 'h').format('X'));
       ...
       */
       ...
       <?php $__currentLoopData = $eventsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oneevent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       {
           start: "<?php echo e($oneevent->start); ?>",
           end: "<?php echo e($oneevent->end); ?>",
           title: "<?php echo e($oneevent->title); ?>",
           content: "<?php echo e($oneevent->content); ?>",
           category:"<?php echo e($oneevent->category); ?>"
       },
...
<?php /**PATH C:\xampp\htdocs\NutPen2\NutPen\resources\views/calendar.blade.php ENDPATH**/ ?>