            ...
            <div class="tm-bg-primary-dark tm-block">
                <div class="kozepre">
                    ...
                    <form action="/jelszoVisszaallitas/save" id="formkuld" class="kozepform" method="post">
                        <?php echo csrf_field(); ?>
                        <p class="text-white mt-5 mb-5">Azonsoító: <b><?php echo e($UserID); ?></b></p>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\NutPen2\NutPen\resources\views/reset.blade.php ENDPATH**/ ?>