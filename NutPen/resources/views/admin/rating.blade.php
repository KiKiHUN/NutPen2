                        ...
                        <tbody id="myTable">
                            ...
                            @foreach ($ratings as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->Name }}</td>
                                    <td>{{ $item->Value}}</td>
                                    <td><button onclick="location.href = '/ertekelestipusmodositas/{{ $item->ID }}';" >Módosítás</button></td>
                                    <td><button onclick="location.href = '/ertekelestipustorles/{{ $item->ID }}';" >Törlés</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    @else
                        ...
                        @else
                            @if ($status ==4)       <!--//Értékelések listázása a tanórában szereplő diákoknak osztályra szűrve-->
                                <h2 class="tm-block-title">{{ $classname }} osztály diákjainak értékelései</h2>
                                <button onclick="location.href = '/tanorak/ujertekeles/{{ $lessonID }}/osztaly/{{ $classID }}';" >Új értékelés</button>
                                <table id='dtBasicExample' class="table table-bordered table-striped table-sm ">
                                    <thead>
                                        <tr>
                                            <th class="th-sm">Azonosító</th>
                            ...
                            @else
                                ...
                                @else
                                    @if ($status ==6)    <!--//Diák jegyéének módosítása-->
                                                ...
                                                <tbody id="myTable">
                                                    @foreach ($ratings as $item)
                                                        <tr>
                                                            ...
                                                            <td><button onclick="location.href = '/ertekelesmodositas/{{ $item->ID }}';" >Módosítás</button></td>
                                                            <td><button onclick="location.href = '/ertekelestorles/{{ $item->ID }}';" >Törlés</button></td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
