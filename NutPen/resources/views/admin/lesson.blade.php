                        ...
                        <tbody id="myTable">
                            @foreach ($lessons as $item)
                                <tr>
                                    ...
                                    <td><button onclick="location.href = '/naptar/tanorak/{{ $item->ID }}';" >Naptár</button></td>
                                    <td><button onclick="location.href = '/osztalyok/tanora/{{ $item->ID }}';" >Osztályok listázása</button></td>
                                    <td><button onclick="location.href = '/tanoramodositas/{{ $item->ID }}';" >Szerkesztés</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    @else
                        ...
                        @else
                            @if ($status ==4)       <!-- //Tanórához kapcsolt osztályok és diákok és értékelés-->
                                ...
                                <button onclick="location.href = '/tanorak/osztalyhozzad/{{ $lessonID }}';" >Új osztály hozzáadása a tanórához</button>
                                <table id='dtBasicExample' class="table table-bordered table-striped table-sm ">
                                    <thead>
                                        <tr>
                                            <th class="th-sm">Azonosító</th>
                                    ...
                                    <tbody id="myTable">
                                        @foreach ($classes as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->Name }}</td>
                                                <td>{{ $item->GetTeacher->FName." ".$item->GetTeacher->LName }}</td>
                                                <td><button onclick="location.href = '/ertekelesek/tanora/{{  $lessonID }}/osztaly/{{ $item->ID }}';" >Értékelések</button></td>
                                                <td><button onclick="location.href = '/osztaly/diakok/{{ $item->ID }}';" >Diákok listázása</button></td>
                                                <td><button onclick="location.href = '/tanora/{{ $lessonID }}/osztalytorles/{{ $item->ID }}';" >Törlés</button></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
