                        ...
                        <tbody id="myTable">
                            @foreach ($roles as $item)
                                <tr>
                                    ...
                                    <?php
                                    ?>
                                    <td><button onclick="location.href = '/rangmodositas/{{ $item->ID }}';" >Szerkesztés</button></td>
                                    <td><button onclick="location.href = '/felhasznalok/{{ strtolower(mb_substr($item->Name, 0, 1)) }}'" >Felhasználók listázása</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
