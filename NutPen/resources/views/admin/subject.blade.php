                        ...
                        <tbody id="myTable">
                            @foreach ($subjects as $item)
                                <tr>
                                    ...
                                    <td><button onclick="location.href = '/tantargymodositas/{{ $item->ID }}';" >Szerkesztés</button></td>
                                    <td><button onclick="location.href = '/tantargy/orak/{{ $item->ID }}';" >Tanórák listázása</button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
