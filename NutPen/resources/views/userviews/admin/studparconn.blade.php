        ...
        <div class="col-12 tm-block-col">
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                @if ($status == 0)
                    ...
                    <button class="NewItemButton" onclick="location.href = '/admin/kapcsolat/ujszulodiak';" >Hozzáadás</button>
                        ...
                        <tbody id="myTable">
                            @foreach ($conns as $item)
                                <tr>
                                    ...
                                    <td><div class="btnplacer"><button class="RemoveButton" onclick="location.href = '/admin/kapcsolat/szulodiaktorles/{{ $item->StudentID }}/{{ $item->ParentID }}';" >Törlés</button></div></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @if ($status == 2)
                    <h2 class="tm-block-title">Új diák-szülő kapcsolat</h2>
                        ...
                        <form id="ujRang" class="formCenterContent" action="/admin/kapcsolat/ujszulodiakmentes" method="post">
                            @csrf
                            <div class="NewUser">
