                        ...
                        <tbody id="myTable">
                            @foreach ($classes as $item)
                                <tr>
                                    ...
                                    <td><div class="btnplacer"><button class="EditButton" onclick="location.href = '/admin/osztalymodositas/{{ $item->ID }}';" >Szerkesztés</button></div></td>
                ...
                @else
                    @if ($status == 2)         <!-- //új osztály-->
                        <h2 class="tm-block-title">Új osztály</h2>
                            ...
                            <form id="ujFelh" class="formCenterContent" action="/admin/ujosztalymentes" method="post">
                                @csrf
                                <div class="NewUser">
                    ...
                    @else
                        ...
                        @else
                            @if ($status ==4)       <!-- //osztályban diákok és törlése és hozzáadása gomb-->
                                ...
                                <button class="NewItemButton" onclick="location.href = '/admin/osztalyok/diakhozzad/{{ $classID }}';" >Új diák összekapcsolása</button>
                                <table id='dtBasicExample' class="table table-bordered table-striped table-sm ">
                                    <thead>
                                        <tr>
                            ...
                            @else
                                @if ($status ==5)     <!--//diák felvétele osztályba-->
                                        ...
                                        <form id="ujFelh" class="formCenterContent" action="/admin/osztalyok/diakhozzad/mentes" method="post">
                                            @csrf
