        ...
        <div class="col-12 tm-block-col">
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                @if ($status == 0)
                    ...
                    <button class="NewItemButton" onclick="location.href = '/admin/ujfigyelmeztetes';" >Hozzáadás</button>
                        ...
                        <tbody id="myTable">
                            @foreach ($warnings as $item)
                                <tr>
                                    ...
                                    <td>{{ $item["datetime"] }}</td>
                                    <td><div class="btnplacer"><button class="EditButton" onclick="location.href = '/admin/figyelmeztetesmodositas/{{ $item['ID'] }}';" >Szerkesztés</button></div></td>
                                    <td><div class="btnplacer"><button class="RemoveButton" onclick="location.href = '/admin/figyelmeztetestorles/{{ $item['ID'] }}';" >Törlés</button></div></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @if ($status == 2)
                    <h2 class="tm-block-title">Új Figyelmeztetés</h2>
                        ...
                        <form id="ujRang" class="formCenterContent" action="/admin/ujfigyelmeztetesmentes" method="post">
                            @csrf
                            <div class="NewUser">
                ...
                @if ($status ==3)
                    <h2 class="tm-block-title">Figyelmeztetés módosítása</h2>
                        ...
                        <form id="ujRang" class="formCenterContent" action="/admin/figyelmeztetesmodositas" method="post">
                            @csrf
