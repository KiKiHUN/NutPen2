        ...
        <div class="col-12 tm-block-col">
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                @if ($status == 0)
                    ...
                    <button class="NewItemButton"  onclick="location.href = '/fo/ujesemeny';" >Új Esemény</button>
                    <button class="OtherFunctionButton rightspacer" id="alleventCalendarHead" >Összes a naptárba</button>
                        ...
                        <tbody id="myTable">
                            ...
                            @foreach ($events as $item)
                                <tr>
                                    ...
                                    <td> <div class="btnplacer"><button class="EditButton" onclick="location.href = '/fo/esemenymodositas/{{ $item->ID }}';" >Szerkesztés</button></div></td>
                                    <td><div class="btnplacer"><button class="RemoveButton" onclick="location.href = '/fo/esemenytorles/{{ $item->ID }}';" >Törlés</button></div></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @if ($status == 2)
                    ...
                    <form id="ujFelh" class="formCenterContent" action="/fo/ujesemeny/" method="post">
                        @csrf
                        <div class="NewUser">
                ...
                @if ($status ==3)
                    ...
                    <form id="ujFelh" class="formCenterContent" action="/fo/esemenymodositas/" method="post">
                        @csrf
