            ...
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        ...
                        <tbody id="myTable">
                            @foreach ($users as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->fname }}</td>
                                    <td>{{ $item->lname }}</td>
                                    <td> <div class="btnplacer"><button class="EditButton" onclick="location.href = '/fo/felhasznalomodositas/{{ $item->UserID }}';" >Szerkesztés</button></div></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @if ($status == 2)
                    ...
                    <p id="hiba" style="color: red"></p>
                        <form id="ujFelh" class="formCenterContent" action="/fo/ujfelhasznalomentes" method="post">
                            @csrf
                            <div class="NewUser">
