            ...
            <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        ...
                        <tbody id="myTable">
                            @foreach ($subjects as $item)
                                <tr>
                                    ...
                                    <td><div class="btnplacer"><button class="EditButton" onclick="location.href = '/fo/tantargymodositas/{{ $item->ID }}';" >Szerkesztés</button></div></td>
                                    <td><div class="btnplacer"><button class="OtherFunctionButton" onclick="location.href = '/fo/tantargy/orak/{{ $item->ID }}';" >Tanórák listázása</button></div></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @if ($status == 2)
                    <h2 class="tm-block-title">Új tantárgy</h2>
                        ...
                        <form id="ujFelh" class="formCenterContent" action="/fo/ujtantargymentes" method="post">
                            @csrf
                            <div class="NewUser">
                ...
                @if ($status ==3)
                    <h2 class="tm-block-title">Tantárgy módosítás</h2>
                        ...
                        <form id="ujFelh" class="formCenterContent" action="/fo/tantargymodositas" method="post">
                            @csrf
