...
namespace App\Http\Controllers\HeadUser;
...
//parentstudent
   ...
   {
       return view('userviews/headuser/studparconn',['status'=>0,'conns'=>StudentParent::with(["GetStudent","GetParent"])->get()]);
   }
   ...
   function RemoveStudPar($studentID,$parentID) 
   {
       ...
       return redirect('/fo/kapcsolat/szulodiak')->with('successmessage', "sikeres mentés");
   }

   function NewStudPar()
   {
       return view('userviews/headuser/studparconn',['status'=>2,"parents"=>StudParent::all(),'students'=>Student::all()]);
   }
...
//parentstudent
    ...
    //roles
        function Roles()
        {
            return view('userviews/headuser/role',['status'=>0,'roles'=>RoleType::all()]);
        }
...
//backupAndNuke
   ...
   {
       return view('/areyousure',['gotopage'=>"/headuser/".$link]);
   }
...
//banner
   function Banner()
   {
       ...
       return view('userviews/headuser/banner',['status'=>0,'banners'=>$msg]);
   }

   function EditBannerPage($bannerID)  {
       $banner=BannerMsg::GetMSGIfExist($bannerID);
       if (!$banner) {
           return redirect('/fo/banner')->with('failedmessage', "ID nem található");
       }
       if ($banner->ImagePath) 
       {
   ...
   {
       return view('userviews/headuser/banner',['status'=>2]);
   }
...
//classes
   function SchoolClasses()
   {
       ...
       return view('userviews/headuser/school_Classes',['status'=>0,'classes'=>$classesWithTeachers]);
   }
   ...
   function ClassStudents($classID) 
   {
       ...
       return view('userviews/headuser/school_Classes',['status'=>4,'users'=>$users,'classID'=>$classID,'className'=> $class->Name]);
   }
   ...
   function RemoveStudentFromClass($classID,$studentID) 
   {
       ...
       return redirect('/fo/osztaly/diakok/'.$classID)->with('successmessage', "sikeres mentés");
   }
   ...
   function AddStudentToClass($classID) 
   {
       ...
       return view('userviews/headuser/school_Classes',['status'=>5,'students'=>$studentsNotInClass,'classID'=>$classID]);
   }
   ...
   function EditClassPage($classID)  {
       ...
       if (!$class) {
           return redirect('/fo/osztalyok')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/school_Classes',['status'=>3,'classinfo'=>$class,'teachers'=>Teacher::query()->orderBy('FName', 'desc')->get()]);
   }
   ...
   function EditClass(Request $request) 
   {
       ...
       return redirect('/fo/osztalyok')->with('successmessage', "sikeres mentés");
   }

   function NewClass()
   {
       return view('userviews/headuser/school_Classes',['status'=>2,'teachers'=>Teacher::query()->orderBy('FName', 'desc')->get()]);
   }
...
//subjects
   function Subjects()
   {
       return view('userviews/headuser/subject',['status'=>0,'subjects'=>Subject::all()]);
   }
   ...
   function SubjectLessons($sujectID) 
   {
       ...
       return view('userviews/headuser/lesson',['status'=>0,'lessons'=>$sub->GetLessons]);
   }

   function EditSubjectPage($sujectID)  {
       $subject=Subject::GetSubjectIfExist($sujectID);
       if (!$subject) {
           return redirect('/fo/tantargyak')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/subject',['status'=>3,'subject'=>$subject]);
   }
   ...
   function EditSubject(Request $request) 
   {
       ...
       return redirect('/fo/tantargyak')->with('successmessage', "sikeres mentés");
   }

   function NewSubject()
   {
       return view('userviews/headuser/subject',['status'=>2]);
   }
...
//lessons
   function Lessons()
   {
       ...
       return view('userviews/headuser/lesson',['status'=>0,'lessons'=>$lessonsWithTeachersAndSubject]);
   }

   function LessonsClasses($lessonID) 
   {
       $lesson=Lesson::with(['GetClasses','GetSubject','GetTeacher'])->where('ID', '=', $lessonID)->first();
       return view('userviews/headuser/lesson',['status'=>4,'classes'=>$lesson->GetClasses,"subjectName"=>$lesson->GetSubject->Name,"teacherName"=>($lesson->GetTeacher->FName." ".$lesson->GetTeacher->LName),"lessonID"=>$lessonID]);
   }
   ...
   function AddClassToLesson($lessonID) 
   {
       ...
       return view('userviews/headuser/lesson',['status'=>5,'classes'=>$classIdsNotInLesson,'lessonID'=>$lessonID]);
   }
   ...
   function EditLessonPage($lessonID)  {
       ...
       if (!$lesson) {
           return redirect('/fo/tanorak')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/lesson',['status'=>3,'lesson'=>$lesson,'teachers'=>$teachers,'subjects'=>$subjects]);
   }
   ...
   function EditLesson(Request $request) 
   {
       ...
       return redirect('/fo/tanorak')->with('successmessage', "sikeres mentés");
   }
   ...
   function NewLesson()
   {
       ...
       return view('userviews/headuser/lesson',['status'=>2,'teachers'=>$teachers,'subjects'=>$subjects]);
   }
...
//ratingtypes
   ...
   {
       return view('userviews/headuser/rating',['status'=>2]);
   }
   function RatingTypes()
   {
       return view('userviews/headuser/rating',['status'=>0,'ratings'=>GradeType::all()]);
   }

   function EditRatinTypegPage($gradeID)  {
       $gradetype=GradeType::GetGradeIfExist($gradeID);
       if (!$gradetype) {
           return redirect('/fo/ertekelestipusok')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/rating',['status'=>3,'rating'=>$gradetype]);
   }
   ...
   function EditRatingType(Request $request) 
   {
       ...
       return redirect('/fo/ertekelestipusok')->with('successmessage', "sikeres mentés");
   }
...
//ratings
   ...
   function RatingsLessons($lessonID,$classID)
   {
       ...
       return view('userviews/headuser/rating',['status'=>4,'gradesByStudent'=>$gradesByStudent,"classname"=>$class->Name,'subjectName'=>$lesson->GetSubject->Name,'lessonID'=>$lessonID,'classID'=>$classID]);
   }
   ...
   function  AddNewRatingToLessonClass($lessonID,$classID)
   {
       ...
       return view('userviews/headuser/rating',['status'=>5,'students'=>$class->GetStudents,"classname"=>$class->Name,'classID'=>$classID,'lessonID'=>$lessonID,'grades'=>GradeType::all()]);
   }
   ...
   function SaveNewRatingToLessonClass(Request $request) 
   {
       ...
       DB::commit();
       return redirect('/fo/ertekelesek/tanora/'.$request->lessonID.'/osztaly/'.$request->classID)->with('successmessage', "sikeres mentés");
   }
   ...
   {
       return view('userviews/headuser/rating',['status'=>6,'ratings'=>Grade::with(['GetStudent','GetLesson.GetSubject','GetLesson.GetTeacher','GetGradeType'])->latest()->take(20)->get()]);
   }
   ...
   function RemoveStudentGrade($ratingID) 
   {
       ...
       return redirect('/fo/ertekelesek')->with('successmessage', "sikeres mentés");
   }
   ...
   function EditStudentRatingPage($gradeID)  
   {
       ...
       if (!$grade) {
           return redirect('/fo/ertekelesek')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/rating',['status'=>7,'rating'=>$grade,'grades'=>GradeType::all()]);
   }
...
//verifications types
   ...
   {
       return view('userviews/headuser/missings',['status'=>2]);
   }
   function VerifTypes()
   {
       return view('userviews/headuser/missings',['status'=>0,'veriftypes'=>VerificationType::all()]);
   }
   ...
   function EditVerifTypegPage($verifID)  
   {
       ...
       if (!$veriftype) {
           return redirect('/fo/igazolastipusok')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/missings',['status'=>3,'verif'=>$veriftype]);
   }
   function SaveVerifType(Request $request) 
   {
       ...
       return redirect('/fo/igazolastipusok')->with('successmessage', "sikeres mentés");
...
//lates-missings
   ...
   {
       return view('userviews/headuser/missings',['status'=>6,'missings'=>LatesMissing::with(['GetStudent','GetLesson.GetSubject','GetLesson.GetTeacher','GetVerificationType'])->latest()->take(20)->get()]);
   }
   function RemoveStudentMissing($missID) 
   {
       ...
       return redirect('/fo/hianyzasok')->with('successmessage', "sikeres mentés");
   }
   ...
   function EditStudentMissingPage($missID)  
   {
       ...
       if (!$miss) {
           return redirect('/fo/hianyzasok')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/missings',['status'=>7,'missing'=>$miss,'VerifTypes'=>VerificationType::all()]);
   }
   ...
   function MissingsLessons($lessonID,$classID)
   {
       ...
       return view('userviews/headuser/missings',['status'=>4,'missingsByStudent'=>$missingsByStudent,"classname"=>$class->Name,'subjectName'=>$lesson->GetSubject->Name,'lessonID'=>$lessonID,'classID'=>$classID]);
   }
   ...
   function  AddNewissingToLessonClass($lessonID,$classID)
   {
       ...
       return view('userviews/headuser/missings',['status'=>5,'students'=>$class->GetStudents,"classname"=>$class->Name,'classID'=>$classID,'lessonID'=>$lessonID,'verifTypes'=>VerificationType::all()]);
   }
   ...
   function SaveNewissingToLessonClass(Request $request) 
   {
       ...
       DB::commit();
       return redirect('/fo/hianyzasok/tanora/'.$request->lessonID.'/osztaly/'.$request->classID)->with('successmessage', "sikeres mentés");
   }
...
//warnings
   ...
   function EditWarningPage($warningID)  
   {
       ...
       if (!$warning) {
           return redirect('/fo/figyelmeztetesek')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/warning',['status'=>3,'warning'=>$warning,'students'=>Student::all( )]);
   }
   ...
   function EditWarning(Request $request) 
   {
       ...
       return redirect('/fo/figyelmeztetesek')->with('successmessage', "sikeres mentés");
   }

   function NewWarning()
   {
       return view('userviews/headuser/warning',['status'=>2,'students'=>Student::all()]);
   }
...
//homeworks
   function HomeWorks()
   {
       return view('userviews/headuser/homework',['status'=>0,'homeworks'=>HomeWork::with(['GetLesson.GetTeacher','GetLesson.GetSubject','GetLesson.GetClasses'])->get()]);
   }
   function StudentsHomeWorks($homewokID)
   {

       return view('userviews/headuser/homework',['status'=>4,'homeworks'=>HomeWorkStudent::with(['GetStudent','GetHomework'])->where([
   ...
   function HomeWorkClasses($homewokID) 
   {
       ...
       return view('userviews/headuser/school_Classes',['status'=>0,'classes'=>$classes]);
   }
   function EditHomeWorkPage($homewokID)  
   {
       $homework=HomeWork::GetHomeworkIfExist($homewokID);
       if (!$homework) {
           return redirect('/fo/hazifeladatok')->with('failedmessage', "ID nem található");
       }
       return view('userviews/headuser/homework',['status'=>3,'homework'=>$homework,'lessons'=>Lesson::with(['GetSubject','GetClasses','GetTeacher'])->get()]);
   }
   ...
   {
       return view('userviews/headuser/homework',['status'=>2,'lessons'=>Lesson::with(['GetSubject','GetClasses','GetTeacher'])->get()]);
   }
